...
module.exports =
    ...
    getAction: (state) ->
        @getRouteObject(state).get('action')


    getAccountID: (state) ->
        @getRouteObject(state).get('accountID')


    getMailboxID: (state) ->
        @getRouteObject(state).get('mailboxID')


    getMessageID: (state) ->
        @getRouteObject(state).get('messageID')
    ...
    getModalParams: (state) ->
        state.get('modal') # alias for tests
