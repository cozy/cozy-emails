 ...
 */
module.exports.quoteProcessTextBody = function quoteProcessTextBody(fullBodyText) {
  var contentRep = [];
  var line;
  /**
 ...
 */
module.exports.generateSnippet = function generateSnippet(rep, desiredLength) {
...
module.exports.expandQuotedPrefix = function expandQuotedPrefix(s, depth) {
 ...
 * whitespace injected.)
 */
module.exports.expandQuoted = function expandQuoted(s, depth) {
 ...
 */
module.exports.generateReplyText = function generateReplyText(rep) {
  var strBits = [];
  for (var i = 0; i < rep.length; i += 2) {
    var etype = rep[i]&0xf, block = rep[i + 1];
    switch (etype) {
 ...
 */
module.exports.generateForwardBodyText = function generateForwardBodyText(rep) {
  var strBits = [], nl;
