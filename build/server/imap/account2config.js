...
var Account, CLIENT_ID, CLIENT_SECRET, PasswordEncryptedError, getXoauth2Generator, log, xOAuthCache, xoauth2;
...
module.exports.makeIMAPConfig = function(account, callback) {
  var generator;
  if (account.oauthProvider === "GMAIL") {
