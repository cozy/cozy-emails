...
var Account, AccountConfigError, Imap, ImapPool, RecoverChangedUIDValidity, Scheduler, TimeoutError, async, connectionID, forceOauthRefresh, log, makeIMAPConfig, rawImapLog, xoauth2, _ref, _ref1,
...
_ref1 = require('../imap/account2config'), makeIMAPConfig = _ref1.makeIMAPConfig, forceOauthRefresh = _ref1.forceOauthRefresh;
    ...
    return makeIMAPConfig(this.account, (function(_this) {
      return function(err, options) {
        ...
        return _this.wrongPortTimeout = setTimeout(function() {
          ...
          imap.removeListener('error', onConnError);
          onConnError(new TimeoutError("Timeout connecting to " + (((_ref2 = _this.account) != null ? _ref2.imapServer : void 0) + ":" + ((_ref3 = _this.account) != null ? _ref3.imapPort : void 0))));
          return imap.destroy();
        }, 10000);
      };
    })(this));
        ...
        return task.operation(imap, (function(_this) {
          return function(err) {
            ...
            process.nextTick(function() {
              var _ref2;
              if ((_ref2 = task.callback) != null) {
                _ref2.apply(null, args);
              }
