...
var Account, AccountConfigError, Imap, ImapPool, TimeoutError, connectionID, log, rawImapLog, _ref,
...
ImapPool = (function() {
  ...
  ImapPool.prototype._getAccount = function() {
    ...
    return Account.find(this.accountID, (function(_this) {
      return function(err, account) {
        ...
        if (!account) {
          return _fatal(new NotFound("Account " + _this.accountID));
        }
  ...
  ImapPool.prototype._onActiveClose = function(connection, err) {
    ...
    if (task = this.pending[connection.connectionID]) {
  ...
  ImapPool.prototype._giveUp = function(err) {
    ...
    while (task = this.tasks.pop()) {
      _results.push(task.callback(err));
    }
    return _results;
  };
