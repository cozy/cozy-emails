...
var ImapConnection, ImapImpossible, MailParser, NodeImapConnection, async, errors, isFolderDuplicate, isFolderForbidden, isFolderUndeletable, log, mailutils, stream_to_buffer_array, _, _old1,
...
module.exports = ImapConnection = (function(_super) {
  __extends(ImapConnection, _super);
  ...
  ImapConnection.prototype.multimove = function(uids, dests, callback) {
    ...
    if (uids.length === 0) {
      ...
      first = dests[0], rest = 2 <= dests.length ? __slice.call(dests, 1) : [];
