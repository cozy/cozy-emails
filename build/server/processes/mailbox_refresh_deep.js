...
var FETCH_AT_ONCE, MailboxRefreshDeep, Message, Process, RefreshError, _, async, log, patchConversation, ramStore, safeLoop,
...
module.exports = MailboxRefreshDeep = (function(superClass) {
  ...
  function MailboxRefreshDeep() {
    ...
    this.convPatch = bind(this.convPatch, this);
