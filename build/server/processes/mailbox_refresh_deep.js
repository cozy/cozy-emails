...
var FETCH_AT_ONCE, MailboxRefreshDeep, Message, Process, RefreshError, async, log, patchConversation, ramStore, safeLoop, _,
...
module.exports = MailboxRefreshDeep = (function(_super) {
  ...
  function MailboxRefreshDeep() {
    ...
    this.convPatch = __bind(this.convPatch, this);
  ...
  MailboxRefreshDeep.prototype.setNextStep = function(uidnext) {
    ...
    this.max = Math.max(1, this.min - 1);
    this.min = Math.max(1, this.min - range);
