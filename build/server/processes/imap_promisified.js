...
var AccountConfigError, Imap, ImapPromisified, MailParser, Promise, log, open_conn, stream_to_buffer_array, _, _old1;
...
module.exports = ImapPromisified = (function() {
  ...
  ImapPromisified.prototype.getBoxes = function() {
    ...
    return this._super.getBoxesPromised.apply(this._super, arguments).then(function(tree) {
