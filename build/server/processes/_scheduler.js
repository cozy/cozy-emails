...
var ApplicationStartup, EventEmitter, HOUR, MIN, MailboxRefresh, MailboxRefreshList, OrphanRemoval, RemoveAllMessagesFromAccount, Scheduler, async, eventEmitter, lastAllRefresh, lastFavoriteRefresh, log, queued, ramStore, running;
...
Scheduler.orphanRemovalDebounced = function(accountID) {
  var alreadyQueued;
  if (accountID) {
    Scheduler.schedule(new RemoveAllMessagesFromAccount({
      accountID: accountID
    }));
  }
