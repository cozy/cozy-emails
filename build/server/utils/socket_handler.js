...
SocketHandler.setup = function(app, server) {
  ...
  Scheduler.on('indexes.request', function() {
    var args;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    return io.emit.apply(io, ['indexes.request'].concat(slice.call(args)));
  });
  Scheduler.on('indexes.complete', function() {
    var args;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    return io.emit.apply(io, ['indexes.complete'].concat(slice.call(args)));
  });
