...
var Account, AccountConfigError, BadRequest, MSGBYPAGE, Mailbox, Message, NotFound, async, contentToBuffer, log, multiparty, normalizeMessageID, querystring, ramStore, stream_to_buffer, uuid, _, _ref,
...
module.exports.send = function(req, res, next) {
  var account, destination, draftBox, files, isDraft, isFwdAttachment, jdbMessage, message, previousUID, sentBox, steps, uidInDest, _ref1;
  log.debug("send");
  message = req.body;
  ...
  if (isFwdAttachment) {
    steps.push(function(cb) {
      var attachment, binary, filename, _i, _len, _ref2;
      log.debug("send#linking");
      binary = {};
      _ref2 = message.attachments;
