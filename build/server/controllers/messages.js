...
var Account, AccountConfigError, BadRequest, MSGBYPAGE, Mailbox, Message, NotFound, async, contentToBuffer, log, messageUtils, multiparty, querystring, stream_to_buffer_array, _, _ref,
...
module.exports.send = function(req, res, next) {
  var account, destination, draftBox, files, jdbMessage, message, previousUID, sentBox, steps, uidInDest, _ref1;
  log.debug("send");
  message = req.body;
  account = req.account;
  files = req.files;
