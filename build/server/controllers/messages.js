...
var Account, AccountConfigError, BadRequest, MSGBYPAGE, Mailbox, Message, MessageMove, NotFound, SaveOrSendMessage, _, async, crlf, log, minify, multiparty, normalizeMessageID, querystring, ramStore, ref, stream_to_buffer, uuid;
...
module.exports.send = function(req, res, next) {
  var isDraft, message, minifierOpts, proc;
  log.debug("send");
