...
var Constants, Mailbox, MessagesRemovalByMailbox, TestMailbox, async, cozydb, log, ramStore, safeLoop,
...
Mailbox = (function(superClass) {
  ...
  Mailbox.scanBoxesForSpecialUse = function(boxes) {
    var box, boxID, changes, guessRole, guessed, i, len, type;
    guessed = {};
    changes = {
      initialized: true
    };
    ...
    for (guessRole in guessed) {
      boxID = guessed[guessRole];
      if (changes[guessRole] == null) {
        changes[guessRole] = boxID;
      }
    }
