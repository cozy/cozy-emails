...
var Account, AccountConfigError, CONSTANTS, Compiler, ImapPool, Mailbox, MailboxRefreshList, Message, NotFound, RefreshError, RemoveMessageByAccount, SMTPConnection, Scheduler, TestAccount, async, cozydb, log, makeSMTPConfig, nodemailer, notifications, ramStore, refreshTimeout, _, _ref,
...
TestAccount = (function(_super) {
  __extends(TestAccount, _super);
