...
var Account, AccountConfigError, Compiler, ImapPool, ImapReporter, Mailbox, Message, SMTPConnection, async, cozydb, log, nodemailer, _,
...
Account.prototype.toClientObject = function(callback) {
  ...
  return Mailbox.rawRequest('treeMap', {
    ...
    return Message.getUnreadCountByAccount(rawObject.id, function(err, counts) {
      if (err) {
        return callback(err);
      }
