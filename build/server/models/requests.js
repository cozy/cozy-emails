...
module.exports = {
  ...
  message: {
    ...
    byMailboxRequest: {
      reduce: '_count',
      map: function(doc) {
        var boxid, dest, dests, docDate, nobox, sender, uid, uids, xflag, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4;
        nobox = true;
        _ref = doc.mailboxIDs;
        for (boxid in _ref) {
          uid = _ref[boxid];
        ...
        void 0;
        _ref4 = doc.twinMailboxIDs || {};
        for (boxid in _ref4) {
          uids = _ref4[boxid];
          for (_l = 0, _len3 = uids.length; _l < _len3; _l++) {
            uid = uids[_l];
            emit(['uid', boxid, uid], doc.flags);
          }
        }
