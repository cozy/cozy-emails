...
Message.getResultsAndCount = function(mailboxID, params, callback) {
  ...
  if (params.descending) {
    ref1 = [params.after, params.before], params.before = ref1[0], params.after = ref1[1];
  }
  return async.series([
    function(cb) {
...
Message.getCount = function(mailboxID, params, callback) {
  ...
  return Message.rawRequest('byMailboxRequest', {
    ...
    return callback(null, ((ref1 = rows[0]) != null ? ref1.value : void 0) || 0);
  });
};
...
Message.prototype.markTwin = function(box, uid, callback) {
  ...
  if (ref1 = box.id, indexOf.call(hasTwin, ref1) < 0) {
    return callback(null);
  }
  hasTwin.push(box.id);
...
Message.byMessageID = function(accountID, messageID, callback) {
  ...
  return Message.rawRequest('dedupRequest', {
    ...
    message = (ref1 = rows[0]) != null ? ref1.doc : void 0;
    if (message) {
...
Message.prototype.applyPatchOperations = function(patch, callback) {
  var boxOps, boxid, flagsOps, index, j, k, len, len1, newflags, newmailboxIDs, operation, ref1, uid;
  log.debug(".applyPatchOperations", patch);
  newmailboxIDs = {};
  ref1 = this.mailboxIDs;
  for (boxid in ref1) {
    uid = ref1[boxid];
...
Message.prototype.imap_applyChanges = function(newflags, flagsOps, newmailboxIDs, boxOps, callback) {
  ...
  return Mailbox.getBoxesIndexedByID(this.accountID, (function(_this) {
    return function(err, boxIndex) {
      var box, boxID, boxid, firstboxid, firstuid, j, len, ref1;
      if (err) {
        return callback(err);
      }
        ...
        return async.series([
          function(cb) {
            ...
            return imap.multicopy(firstuid, paths, function(err, uids) {
              ...
              for (i = k = 0, ref2 = uids.length - 1; k <= ref2; i = k += 1) {
...
Message.findConversationID = function(mail, callback) {
  var isReplyOrForward, key, keys, ref1, references;
  ...
  } else if (((ref1 = mail.normSubject) != null ? ref1.length : void 0) > 3 && isReplyOrForward) {
...
Message.prototype.toClientObject = function() {
  var attachments, raw, ref1;
  raw = this.toObject();
  if ((ref1 = raw.attachments) != null) {
    ref1.forEach(function(file) {
