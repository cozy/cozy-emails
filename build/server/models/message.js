...
var AccountConfigError, BadRequest, CONCURRENT_DESTROY, CONSTANTS, LIMIT_DESTROY, LIMIT_UPDATE, MSGBYPAGE, MailAdress, Mailbox, MailboxRefresh, Message, NotFound, Scheduler, _, async, cozydb, htmlToText, log, mailutils, ramStore, ref, uuid,
...
module.exports = Message = (function(superClass) {
  ...
  Message.batchMove = function(messages, from, to, callback) {
    ...
    return Message.doGroupedByBox(messages, function(imap, state, nextBox) {
      var currentBox, destBox, destString, expunges, i, id, j, len, len1, message, moves, mustRemove, paths, ref, uid;
      if (fromBox == null) {
