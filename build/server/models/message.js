...
module.exports = Message = (function(_super) {
  ...
  Message.prototype.removeFromMailbox = function(box, noDestroy, callback) {
    var isOrphan, key, mailboxIDs, value, _ref;
    if (noDestroy == null) {
      noDestroy = false;
    }
  ...
  Message.groupWithBox = function(messages, callback) {
    ...
    return Mailbox.getBoxesIndexedByID(accountID, function(err, boxIndex) {
      var boxID, message, messagesIndex, uid, _i, _len, _ref;
      if (err) {
        return callback(err);
      }
      messagesIndex = {};
  ...
  Message.doGroupedByBox = function(messages, iterator, done) {
    ...
    accountID = messages[0].accountID;
    return Message.groupWithBox(messages, function(err, _arg) {
      var boxIndex, messagesIndex, state;
      boxIndex = _arg.boxIndex, messagesIndex = _arg.messagesIndex;
      if (err) {
        return done(err);
      }
      state = {
  ...
  Message.batchMove = function(messages, from, to, callback) {
    ...
    return Message.doGroupedByBox(messages, function(imap, state, nextBox) {
      var box, boxid, currentBox, destBox, destString, expunges, id, message, moves, mustRemove, paths, uid, _i, _j, _len, _len1, _ref, _ref1;
      if (fromBox == null) {
