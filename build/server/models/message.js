...
var BadRequest, CONSTANTS, MSGBYPAGE, MailAdress, MailAttachment, Message, NotFound, _, async, cozydb, htmlToText, log, mailutils, ramStore, ref, uuid,
...
MSGBYPAGE = CONSTANTS.MSGBYPAGE;

ref = require('../utils/errors'), NotFound = ref.NotFound, BadRequest = ref.BadRequest;
